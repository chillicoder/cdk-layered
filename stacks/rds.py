...
class RdsStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, vpc, **kwargs) -> None:
        ...
        cdk.CfnOutput(self,"DatabaseInstanceId",
                      value=instance.instance_endpoint.hostname)

        cdk.CfnOutput(self,"SecretName",
                      value=instance.secret.secret_name)
